  ...
  const chapters = [
...

    {
      ...
      content: [
        ...
        "But Marina wanted to add something special - something about the future. She created an AI training experience where kids could teach a computer to identify marine life and pollution.",
        '"If kids understand how AI works," Marina thought, "they can use these powerful tools to protect the ocean when they grow up!"',
        "Her AI Ocean Guardian taught about training data, bias, and ethics - while making learning fun and hands-on.",
